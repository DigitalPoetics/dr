...
title: 'Diagram'
pubDate: 2026-08-22
description: 'Create and design network diagram in Gephi'
author: 'AB'
image:
...
tags: ['gephi', 'SNA', 'fruchterman reingold', 'postwar US poetry']
series: 'gephi-intro'
seriesOrder: 2
---
...
- Click on the **More Settings** pop up icon on the bottom right corner of the figure **(fig. 6)**, then **Node Labels** > check **Show**.
- Change the font weight too: **Node Labels** > **Font: Arial-BoldMT, 32** > **Style: Regular** > **Ok**.
- Save the file: **File** > **Save**.

![More settings](../../assets/images/gephi-intro/diagram-diagram-nodes-more-settings.webp "More settings")
<figcaption>**Figure 6.** Show Node Labels in More Settings.</figcaption>
...
Your figure should look like this **(fig. 7)**.
...
<figcaption>**Figure 7.** The final design of the network graph.</figcaption>
...
The image for website in 16:9 aspect ratio looks like this **(fig. 8)**. 

![Network graph in 16:9 aspect ration](../../assets/images/gephi-intro/diagram-diagram-networking-web.webp "16:9 aspect ration")
<figcaption>**Figure 8.** The network graph in 16:9 aspect ratio (7680 x 4320 px), perfect for widescreen.</figcaption>
