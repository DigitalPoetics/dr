...
title: 'Data'
pubDate: 2026-08-22
description: 'Create nodes and edges file for network analysis with Gephi'
author: 'AB'
image:
...
In this post, I will list the steps I took to convert the original dataset from the _Networking the New American Poetry_ project to links and nodes files. 
...
```excel
=IFS(ROW(B2:INDEX(B:B; COUNTA(B:B)))<=13; "journal"; ROW(B2:INDEX(B:B; COUNTA(B:B)))>13; "poet")
```
...
- Click on the **Name Box** on the left of the **Formula Bar**, type **A2:A3576** on the **Name Box**, and press **Return**. 
...
<figcaption>**Figure 7.** Edges sheet filled with numerical IDs in Source and Target columns.</figcaption>
