...
In this post, I will list the steps I took to convert the original dataset from the Networking the New American Poetry website to links and nodes files. 
